...
(def foundation-namespaces
  ...
  '#{isaac.main isaac.startup.cache isaac.startup.classpath-cache isaac.cli.registry isaac.foundation.module isaac.module.protocol isaac.nexus
     ...
     isaac.cli.api isaac.cli.args isaac.cli.color isaac.cli.host isaac.cli.table})
