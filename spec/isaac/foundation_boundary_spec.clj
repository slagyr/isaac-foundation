...
(def foundation-namespaces
  ...
  '#{isaac.main isaac.startup.cache isaac.startup.classpath-cache isaac.startup.config-cache isaac.cli.registry isaac.foundation.module isaac.module.protocol isaac.nexus
